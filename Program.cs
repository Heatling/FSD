...
namespace RINGSDrawing
{
	class Program
	{
		...
		public static void t6Main(String[] args)
		{
			...
			f.Show();
			f.DrawAllCircles(layout);
			f.drawToFile(@"C:\Users\Emad\Dropbox\DTU\Bachelor projekt\report\file-systems\many-equal-files" + "-LexicalKCorrectedBigFilesGreater.png");
			Console.ReadLine();
		}
		...
		public static void evaluateScreenshots()
		{
			...
			using (System.IO.StreamWriter file =
			new System.IO.StreamWriter(@"C:\Users\Emad\Dropbox\DTU\Bachelor projekt\Drawing algorithms\Evaluations\evaluations-LexicalKCorrectedBigFilesGreater-all.txt", false))
			{
				file.WriteLine("File size\tStaticness\tValue/size distance");
